...
- **Smart Contract ID**: `CAC3P5X22L5Z4ZJWWJXZL4A3HJKZLSYZXZJKZLSYZXZJKZLSYZXZJKZL` *(Default testnet placeholder)*
- **Example Transaction Hash (Pledge/Creation)**: `0x...` *(Copy after on-chain call)*
